...
import com.nag.routines.E04.E04UE;
...
public class E04UCJE {
  ...
  public static final int INC1 = 1, LCWSAV = 1, LIWSAV = 610, LLWSAV = 120, LRWSAV = 475;
  ...
  public static void main(String[] args) {
    ...
    /* Local Scalars */
    double objf;
    int i, ifail, inform, iter, j, lda, ldcj, ldr, liwork, lwork, n, nclin, ncnln, sda, sdcjac;
    /* Local Arrays */
    double[] a, bl, bu, c, cjac, clamda, objgrd, r, work, x;
    double[] ruser = new double[1], rwsav = new double[LRWSAV];
    int[] istate, iwork;
    int[] iuser = new int[1], iwsav = new int[LIWSAV];
    ...
    c = new double[Math.max(1, ncnln)];
    cjac = new double[ldcj * sdcjac];
    ...
    E04UE e04ue = new E04UE();
    inform = 0;
    e04ue.eval("Print Level = 10", lwsav, iwsav, rwsav, inform);
